...
class nnUNetTrainer(NetworkTrainer):
    ...
    def update_fold(self, fold):
        ...
        if fold is not None:
            ...
            ##added
            self.output_folder_1 = self.output_folder[0:-1] + "1"
    ...
    def get_basic_generators(self):
        ...
        print(f"previous batch size:{self.batch_size}")
        self.batch_size = int(
            np.ceil(self.batch_size * len(self.dataset_tr) / (0.8 * len(self.dataset)))
        )
